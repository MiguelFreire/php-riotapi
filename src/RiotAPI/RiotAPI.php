...
class RiotAPI {
     ...
     * @return  array
    */
	public function getChampions($free = false, $region = "euw") {
		...
		if($free) {
			...
			throw new Exception("$free must be a boolean", 1);
		}
	}
     ...
     * @return  array
    */
	public function getSummonerBy($summoner, $get_by = "id",  $region = "euw") {
     ...
     * @return  array
    */
	public function getSummoner($summoner_id, $options, $region = "euw") {
		$this->validate_region('summoner', $region);
     ...
     * @return  array
    */
	public function getRecentGames($summoner_id, $region = "euw") {
     ...
     * @return  array
    */
	public function getLeagues($summoner_id, $region = "euw") {
     ...
     * @return  array
    */
	public function getPlayerStats($summoner_id, $options = "summary", $season = "SEASON3",  $region ="euw") {
     ...
     * @return  array
    */
	public function getTeam($summoner_id, $region = "euw") {
    ...
    */
	private function validate_region($module, $region) {
		...
		if (array_key_exists($module, $reference)) {
			...
			if(!in_array($region, $reference_region)) throw new Exception("Error Processing Request", 1);
